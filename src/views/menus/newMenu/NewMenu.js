import { CButton, CCol, CInput,CCard,CCardHeader,CCardBody, CRow,CSelect } from "@coreui/react";
...
<CRow>
<CCol lg="1"></CCol>
                <CCol lg="3">Date Of Birth <span style={{color:"red"}}>*</span></CCol>
                <CCol lg="8">
                <MuiPickersUtilsProvider
            utils={DateFnsUtils}
            libInstance={moment}
          >
            ...
            <CCol lg="1"></CCol>
              ...
              >
               ...
               <CRow>
               <CCol lg="1"></CCol>
                <CCol lg="3">File <span style={{color:"red"}}>*</span></CCol>
                <CCol lg="8">
                <CCard>
                <CCardHeader>
          <h4>File Upload</h4>
